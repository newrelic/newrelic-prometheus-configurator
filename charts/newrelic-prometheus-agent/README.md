...
| config.kubernetes.integrations_filter.app_values | list | `["redis","traefik","calico","nginx","coredns","etcd"]` | app_values used to create the regex used in the relabel config added by the integration filters configuration |
